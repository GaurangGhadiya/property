  ...
  const userRegister = () => {
    ...
    if (signUp.password !== signUp?.confirmPassword) {
      ...
      const body = {
        ...
        otherContacted: signUp?.otherContacted,
      };
      ApiPostNoAuth("/user/signup", body)
        .then((res) => {
          console.log("res", res);
            ...
            <Grid item xs={12} sm={7}>
              ...
              <TabPanel value={value} index={1}>
                ...
                <div className="agree">
                  <FormControlLabel
                    control={
                      <Checkbox onChange={handleSignUp} name="otherContacted" />
                    }
                ...
                <Button className="common_btn" onClick={userRegister}>
                  Register as a User
                </Button>
                <h5 className="terms">
